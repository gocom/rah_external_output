...
* "Forms":http://textpattern.net/wiki/index.php?title=Forms that name is prefixed with @rah_eo_@ can be requested and their output accessed directly using a URL.
...
* Removed: whole user interface. The plugin now uses @rah_eo_@ prefixed forms.
* Removed: @<txp:rah_external_output />@ tag. As forms are now used, normal and more flexible "output_form":http://textpattern.net/wiki/index.php?title=output_form tag can be used.
