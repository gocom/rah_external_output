...
p. Note that for security reasons, HTTP header lines do not support Textpattern tags. Headers are picked from the Form before any Textpattern tags are parsed.
